...
namespace BankApplication
{
    class Program
    {
        ...
        private static void OpenAccountHandler(object sender, AccountEventArgs e)  // обработчик открытия счета
        {
            Console.WriteLine(e.Message);
        }
        private static void AddSumHandler(object sender, AccountEventArgs e)  // обработчик добавления денег на счет
        {
            Console.WriteLine(e.Message);
        }
        private static void WithdrawSumHandler(object sender, AccountEventArgs e)  // обработчик вывода средств
        {
            Console.WriteLine(e.Message);
            if (e.Sum > 0)
                Console.WriteLine("Идем тратить деньги");
        }
        private static void CloseAccountHandler(object sender, AccountEventArgs e)  // обработчик закрытия счета
        {
            Console.WriteLine(e.Message);
        }
    }
