...
{
    public enum AccountType  // Тип счета, перечисление
    {
        Ordinary,
        Deposit
    }
    public class Bank<T> where T : Account  // Параметр Т представляет класс Account и его наследников
    {
        T[] accounts; // Все счета в классе хранятся в массиве accounts
